...
/**
 * Главный компонент подвала сайта.
 * Содержит контактные данные, график работы, социальные сети и полезные навигационные ссылки.
 */

import React from 'react';
import Link from 'next/link';
import { useTranslation } from '@/lib/i18n';
import { Facebook, Twitter, Instagram, Phone, Mail } from '@/app/icon-sets';
